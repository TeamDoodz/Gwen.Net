...
public abstract class OpenTKRendererBase : RendererBase {
	...
	private System.Drawing.Font ToSysFont(Font font) {
		if(font.RendererData is not System.Drawing.Font sysFont || Math.Abs(font.RealSize - font.Size * Scale) > 2) {
			// reload the font (i think)
			FreeFont(font);
			LoadFont(font);
			sysFont = font.RendererData as System.Drawing.Font ?? throw new Exception("¯\\_(ツ)_/¯");
		}
		return sysFont;
	}

	public override FontMetrics GetFontMetrics(Font font) {
		System.Drawing.Font sysFont = ToSysFont(font);
